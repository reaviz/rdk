...
<Preview withSource="open">
  <Story id="examples-overlay-global-overlay--click-to-open" />
</Preview>
...
<Preview withSource="open">
  <Story id="examples-overlay-global-overlay--dialog-example" />
</Preview>
...
<Preview withSource="open">
  <Story id="examples-overlay-connected-overlay--simple" />
</Preview>
...
<Preview withSource="open">
  <Story id="examples-overlay-connected-overlay--tooltip-example" />
</Preview>
...
<Preview withSource="open">
  <Story id="examples-overlay-connected-overlay--menu-example" />
</Preview>
